 ...
 * 
 * Red-Black mycode.datastructure.tree implementation. From Introduction to Algorithms 3rd edition.
 * 
 * @author Ignas Lelys
 * @created May 6, 2011
 * 
...
public class RedBlackTree extends AbstractSelfBalancingBinarySearchTree {
    ...
    /**
     * Slightly modified delete routine for red-black mycode.datastructure.tree.
     * 
     * {@inheritDoc}
     */
    @Override
    ...
    /**
     * Restores Red-Black mycode.datastructure.tree properties after delete if needed.
     */
    ...
    /**
     * Restores Red-Black mycode.datastructure.tree properties after insert if needed. Insert can
