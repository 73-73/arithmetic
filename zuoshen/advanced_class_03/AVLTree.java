package zuoshen.advanced_class_03;

/**
 * Not implemented by zuochengyun
 * 
 * AVL mycode.datastructure.tree implementation.
 * 
 * In computer science, an AVL mycode.datastructure.tree is a self-balancing binary mycode.search mycode.datastructure.tree, and
 * it was the first such data structure to be invented.[1] In an AVL mycode.datastructure.tree, the
 ...
 * cases, where n is the number of nodes in the mycode.datastructure.tree prior to the operation.
 * Insertions and deletions may require the mycode.datastructure.tree to be rebalanced by one or more
 * mycode.datastructure.tree rotations.
 * 
 * @author Ignas Lelys
 * @created Jun 28, 2011
 * 
...
public class AVLTree extends AbstractSelfBalancingBinarySearchTree {
     ...
     * 
     *      AVL mycode.datastructure.tree insert method also balances mycode.datastructure.tree if needed. Additional
     *      height parameter on node is used to track if one subtree is higher
     *      than other by more than one, if so AVL mycode.datastructure.tree rotations is performed
     *      to regain balance of the mycode.datastructure.tree.
     */
    @Override
    ...
    /**
     * Node of AVL mycode.datastructure.tree has height and balance additional properties. If balance
